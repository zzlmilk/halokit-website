...
new loader([
	...
	var _sceen_1_1 = document.getElementById("sceen-1-1");
	var _sceen_1_2 = document.getElementById("sceen-1-2");

	//初始化高度sceen_1_1高度
	window.addEventListener("load", function(e) {
		_sceen_1_1.style.height = document.documentElement.clientHeight + "px";
	});

	// 第二个场景
	_sceen_1_1.addEventListener("touchend", function(e) {
	...
	// 第三个场景
	_sceen_1_2.addEventListener("touchend", function(e) {
	...
	document.getElementById('btnDrawer').addEventListener('touchstart', function(e) {
		location.href = this.getAttribute('href',1);
	})
	...
	function setBarPosition() {
		...
		switch(index) {
			case 0:
				_bar.style.cssText = 'right: 0;';
				break;
			case 1:
				_bar.style.cssText = 'right: 0;';
				break;
			case 2:
				_bar.style.cssText = 'left: 0;';
				break;
			case 3:
				_bar.style.cssText = 'left: 0;';
				break;
	...
	document.getElementById('linkKnow').addEventListener('touchstart', function(e) {
		location.href = "/h5/about/know";
	})

	document.getElementById('linkContact').addEventListener('touchstart', function(e) {
		location.href = "/h5/about/contact";
	})
}).imgLoader();